...
class MainPhoto(models.Model):
    image = models.ImageField(upload_to='static/products_photos/main_photo', blank=True)

    def __str__(self):
        return self.image.name

class SecondaryPhoto(models.Model):
    image = models.ImageField(upload_to='static/products_photos/secondary_photos', blank=True)
...
class Category(models.Model):
    name = models.CharField(max_length=255)
    preview_photo = models.ImageField(upload_to='static/category_photos', blank=True)
...
class MainBlogPhoto(models.Model):
    image = models.ImageField(upload_to='static/blog_photos/main_photo/', blank=True)

    def __str__(self):
        return self.image.name

class SecondaryBlogPhoto(models.Model):
    image = models.ImageField(upload_to='static/blog_photos/secondary_photos/', blank=True)
