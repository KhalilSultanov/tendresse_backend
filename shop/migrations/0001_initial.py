# Generated by Django 5.0.3 on 2024-04-20 10:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preview_photo', models.ImageField(blank=True, null=True, upload_to='gstatic/category_photos')),
            ],
        ),
        migrations.CreateModel(
            name='Color',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, null=True, upload_to='gstatic/blog_photos/main_photo/')),
            ],
        ),
        migrations.CreateModel(
            name='MainPhoto',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, null=True, upload_to='gstatic/products_photos/main_photo')),
            ],
        ),
        migrations.CreateModel(
            name='Manufacturer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, null=True, upload_to='gstatic/blog_photos/secondary_photos/')),
            ],
        ),
        migrations.CreateModel(
            name='SecondaryPhoto',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, null=True, upload_to='gstatic/products_photos/secondary_photos')),
            ],
        ),
        migrations.CreateModel(
            name='Size',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sale', models.FloatField(blank=True, default=0.0, null=True)),
